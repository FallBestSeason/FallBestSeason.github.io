  ...
  <div class="cCen">
    <div class="text-light bg-dark c-bg-pad">
      ...
      <div class="cItem hContainer">Resume: 
        <div class="hItem">
          <a href="/resume2025-public.pdf" target="_blank" rel="noopener noreferrer">.PDF </a>
        </div>
        <div class="hItem">
          <a href="/resume2025-public.rtf" target="_blank" rel="noopener noreferrer">.RTF </a>
        </div>
        <div class="hItem">
          <a href="/resume2025-public.docx" target="_blank" rel="noopener noreferrer">.DOCX</a>
        </div>
      </div>
    </div>
  </div>
